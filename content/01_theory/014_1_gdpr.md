...
```{exercise} Memorization of personal data with ChatGPT
Testing memorization of personal data with ChatGPT: Ask ChatGPT about yourself.
```

```{exercise} Memorization of personal data with open-weight models
...
* ["AI how-to sheets"](https://www.cnil.fr/fr/ai-how-to-sheets) from Commission Nationale de l’Informatique et des Libertés (CNIL)
   * [Sheet 12: Ensuring the security of an AI system’s development](https://www.cnil.fr/fr/node/165855)
   * [Sheet 13: Analysing the status of an AI model with regard to the GDPR](https://www.cnil.fr/fr/node/167980)